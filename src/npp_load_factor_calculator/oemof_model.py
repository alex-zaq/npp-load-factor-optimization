...
from npp_load_factor_calculator.custom_model import Custom_model
...
class Oemof_model:
    ...
    def __init__(self, scenario, model_settings):
        ...
        self.custom_slice = model_settings["custom_slice"]
    ...
    def _init_oemof_model(self):
        first_time_step = datetime(2025, 1, 1, 0, 0, 0) + timedelta(hours=self.custom_slice[0])
        periods_count = self.custom_slice[1] - self.custom_slice[0] + 1
